    ...
    var g = window.MutationObserver || window.WebKitMutationObserver || !1,
        ...
        y = function() {
            ...
            t.hastransform && (o.style[t.trstyle] = "translate3d(1px,2px,3px)",
                ...
                t.prefixstyle = "",
                t.transitionend = !1;
            for (var r = ["transition", "webkitTransition", "MozTransition", "OTransition", "OTransition", "msTransition", "KhtmlTransition"],
        ...
        b = function(e, o) {
            ...
            function m(e, o, t, r) {
                v._bind(e, o, function(r) {
                    ...
                    r.wheelDeltaX && (i.deltaX = -1 / 40 * r.wheelDeltaX)) : i.deltaY = r.detail, t.call(e, i)
                }, r)
            }
            ...
            function f(e, o, t) {
                ...
                if (0 == e.deltaMode ? (r = -Math.floor(e.deltaX * (v.opt.mousescrollstep / 54)),
                        ...
                        i = -Math.floor(e.deltaY * v.opt.mousescrollstep)), o && v.opt.oneaxismousemode && 0 == r && i && (r = i, i = 0),
                    r && (v.scrollmom && v.scrollmom.stop(), v.lastdeltax += r,
                        v.debounced("mousewheelx",
                            function() {
                        var e = v.lastdeltax;
            ...
            this.doc = v.opt.doc,
                this.iddoc = this.doc && this.doc[0] ?
                this.doc[0].id || "" : "",
                this.ispage = /BODY|HTML/.test(v.opt.win ?
                    v.opt.win[0].nodeName :
                    this.doc[0].nodeName),
                this.haswrapper = v.opt.win !== !1,
                this.win = v.opt.win || (this.ispage ?
                        c(window) :
                        this.doc),
                this.docscroll = this.ispage && !this.haswrapper ?
                    c(window) :
                    this.win,
                this.body = c("body"),
                this.viewport = !1,
                ...
                this.onmousedown = !1,
                this.onmouseup = !1, this.onmousemove = !1,
                this.onmousewheel = !1,
                this.onkeypress = !1,
            ...
            S.cantouch && S.ischrome && !S.isios && !S.isandroid &&
            ...
            v.opt.enablemouselockapi || (S.hasmousecapture = !1,
                ...
                v.doc.translate.y = e, v.doc.translate.ty = -1 * e + "px",
                    v.doc.css(S.trstyle,
                        "translate3d(" + v.doc.translate.tx + "," + v.doc.translate.ty + ",0px)"),
                ...
                v.doc.translate.x = e,
                    ...
                    v.doc.css(S.trstyle,
                        "translate3d(" + v.doc.translate.tx +
                        "," + v.doc.translate.ty + ",0px)"),
                o || v.notifyScrollEvent(v.win[0])
            }) : (this.setScrollTop = function(e, o) {
                v.doc.translate.y = e, v.doc.translate.ty = -1 * e + "px",
                    v.doc.css(S.trstyle,
                        "translate(" + v.doc.translate.tx + "," + v.doc.translate.ty + ")"),
                o || v.notifyScrollEvent(v.win[0])
            }, this.setScrollLeft = function(e, o) {
                v.doc.translate.x = e, v.doc.translate.tx = -1 * e + "px",
                    v.doc.css(S.trstyle,
                        "translate(" + v.doc.translate.tx + "," + v.doc.translate.ty + ")"),
                o || v.notifyScrollEvent(v.win[0])
            ...
            this.getOffset = function() {
                ...
                if (v.ishwscroll) v.rail.css({
                    ...
                    t.left += v.rail.align ?
                    v.win.outerWidth() - u(v.win, "border-right-width") - v.rail.width :
                    ...
                    if (r && (r.top && (t.top += r.top), v.rail.align && r.left && (t.left += r.left)), v.locked || v.rail.css({
                        ...
                        var t = {
                            ...
                            i = v.railh.align ? t.top +
                            u(v.win, "border-top-width", !0) +
                            v.win.innerHeight() - v.railh.height : t.top +
                            u(v.win, "border-top-width", !0),
                ...
                var r, i, n, s;
                v.locked || (v.cancelEvent(e), o ?
                    (r = t ? v.doScrollLeft : v.doScrollTop, n = t ?
                    (e.pageX - v.railh.offset().left - v.cursorwidth / 2) * v.scrollratio.x :
                    (e.pageY - v.rail.offset().top - v.cursorheight / 2) * v.scrollratio.y, r(n)) :
                    (r = t ? v.doScrollLeftBy : v.doScrollBy, n = t ?
                        v.scroll.x : v.scroll.y, s = t ?
                    e.pageX - v.railh.offset().left : e.pageY - v.rail.offset().top, i = t ? v.view.w : v.view.h, r(n >= s ? i : -i)))
                ...
                function o() {
                    ...
                    }), console.log(1)), "contentWindow" in this ?
                    ...
                    v.opt.enablekeyboard && v.bind(e, S.isopera ? "keypress" : "keydown",
                        v.onkeypress),
                    (S.cantouch || v.opt.touchbehavior) &&
                    (v.bind(e, "mousedown", v.ontouchstart), v.bind(e, "mousemove",
                        function(e) {
                        v.ontouchmove(e, !0)
                    }), v.opt.grabcursorenabled && S.cursorgrabvalue && v.css(c(e.body), {
                        cursor: S.cursorgrabvalue
                    })), v.bind(e, "mouseup", v.ontouchend), v.zoom &&
                ...
                if (S.hasmstouch && v.css(v.ispage ? c("html") : v.win, {
                        ...
                        v.zindex = v.ispage || "auto" != v.opt.zindex ?
                            v.opt.zindex : a() || "auto",
                    ...
                    for (var f in m) p = m[f], h = v.opt.railpadding[p], h ?
                        u.css("padding-" + p, h + "px") : v.opt.railpadding[p] = 0;
                    u.append(s), u.width = Math.max(parseFloat(v.opt.cursorwidth),
                            s.outerWidth()) + v.opt.railpadding.left + v.opt.railpadding.right,
                        u.css({
                        width: u.width + "px",
                        zIndex: v.zindex,
                        background: v.opt.background,
                        cursor: "default"
                    }), u.visibility = !0, u.scrollable = !0,
                        u.align = "left" == v.opt.railalign ? 0 : 1,
                        v.rail = u, v.rail.drag = !1;
                    var w = !1;
                    if (!v.opt.boxzoom || v.ispage || S.isieold || (w = document.createElement("div"),
                            v.bind(w, "click", v.doZoom), v.zoom = c(w), v.zoom.css({
                            cursor: "pointer",
                            "z-index": v.zindex,
                        ...
                        y.attr("id", v.id + "-hr"), y.addClass("nicescroll-rails"),
                            y.height = Math.max(parseFloat(v.opt.cursorwidth), s.outerHeight()),
                            y.css({
                            height: y.height + "px",
                            zIndex: v.zindex,
                            background: v.opt.background
                        }), y.append(s), y.visibility = !0, y.scrollable = !0,
                    ...
                    if (v.ispage) u.css({
                        ...
                        if (v.ishwscroll) {
                            ...
                            v.viewport &&
                            (v.body = v.viewport, 0 == /relative|absolute/.test(v.viewport.css("position")) && v.css(v.viewport, {
                                position: "relative"
                            })), u.css({
                                position: z
                            }), v.zoom && v.zoom.css({
                        ...
                        S.isie8 && (v.autohidedom = v.autohidedom.add(v.cursor)), v.railh && (v.autohidedom = v.autohidedom.add(v.railh)),
                        v.railh && S.isie8 && (v.autohidedom = v.autohidedom.add(v.cursorh))) : "scroll" == v.opt.autohidemode ?
                            (v.autohidedom = c().add(v.rail), v.railh && (v.autohidedom = v.autohidedom.add(v.railh))) :
                            "cursor" == v.opt.autohidemode ? (v.autohidedom = c().add(v.cursor), v.railh && (v.autohidedom = v.autohidedom.add(v.cursorh))) :
                            "hidden" == v.opt.autohidemode && (v.autohidedom = !1, v.hide(), v.locked = !1), S.isie9mobile) {
                        v.scrollmom = new x(v), v.onmangotouch = function() {
                            ...
                            if (0 != i) {
                                var n = 0 > t ? -1 : 1,
                                    s = 0 > r ? -1 : 1,
                                    l = +new Date;
                                if (v.mangotouch.lazy && clearTimeout(v.mangotouch.lazy), l - v.mangotouch.tm > 80
                                    || v.mangotouch.dry != n || v.mangotouch.drx != s) v.scrollmom.stop(),
                                    v.scrollmom.reset(o, e), v.mangotouch.sy = e, v.mangotouch.ly = e,
                                    v.mangotouch.sx = o,
                                    v.mangotouch.lx = o,
                                    v.mangotouch.dry = n,
                                    v.mangotouch.drx = s,
                                    ...
                                    v.scrollmom.stop(),
                                        v.scrollmom.update(v.mangotouch.sx - r,
                                        v.mangotouch.sy - t); {
                                        l - v.mangotouch.tm
                                    }
                                    v.mangotouch.tm = l;
                                    var a = Math.max(Math.abs(v.mangotouch.ly - e),
                                        Math.abs(v.mangotouch.lx - o));
                                    v.mangotouch.ly = e, v.mangotouch.lx = o, a > 2 &&
                            ...
                            v.scrollmom = new x(v), v.ontouchstart = function(e) {
                                ...
                                if (!v.locked) {
                                    ...
                                    if (v.hasmoving = !1, v.lastmouseup = !1,
                                        ...
                                        if (!u) return !v.ispage && S.hasmousecapture && o.setCapture(),
                                ...
                                return e.pointerType && 2 != e.pointerType ? !1 :
                                    v.rail.drag && 2 == v.rail.drag.pt && (v.scrollmom.doMomentum(),
                                        v.rail.drag = !1, v.hasmoving && (v.hasmoving = !1,
                                        v.lastmouseup = !0,
                                        v.hideCursor(),
                            ...
                            v.ontouchmove = function(e, o) {
                                ...
                                if (v.rail.drag && 2 == v.rail.drag.pt) {
                                    ...
                                    var s = e.clientY + ofy,
                                        ...
                                        d = a - v.rail.drag.x,
                                        u = v.rail.drag.st - l;
                                    if (v.ishwscroll && v.opt.bouncescroll ? 0 > u ?
                                            u = Math.round(u / 2) :
                                        u > v.page.maxh &&
                                        (u = v.page.maxh + Math.round((u - v.page.maxh) / 2))
                                            : (0 > u && (u = 0, s = 0), u > v.page.maxh && (u = v.page.maxh, s = 0)),
                                        v.railh && v.railh.scrollable) {
                                        var h = v.rail.drag.sl - d;
                                        v.ishwscroll && v.opt.bouncescroll ? 0 > h ? h = Math.round(h / 2) :
                                        h > v.page.maxw &&
                                        (h = v.page.maxw + Math.round((h - v.page.maxw) / 2))
                                            : (0 > h && (h = 0, a = 0),
                                        h > v.page.maxw && (h = v.page.maxw,
                                            a = 0))
                                    }
                                    var p = !1;
                                    if (v.rail.drag.dl) p = !0,
                                        "v" == v.rail.drag.dl ?
                                            h = v.rail.drag.sl :
                                        "h" == v.rail.drag.dl &&
                                        (u = v.rail.drag.st);
                                        ...
                                        if ("v" == v.rail.drag.ck) {
                                            ...
                                            v.rail.drag && 2 == v.rail.drag.pt &&
                                            (v.prepareTransition && v.prepareTransition(0),
                                            v.rail.scrollable && v.setScrollTop(u),
                                                v.scrollmom.update(a, s), v.railh && v.railh.scrollable ?
                        ...
                        v.onmousedown = function(e, o) {
                            ...
                            if (v.rail.drag) {
                                if (S.hasmousecapture && document.releaseCapture(),
                                    v.isiframe && !S.hasmousecapture && v.doc.css("pointer-events",
                                        v.saved.csspointerevents), 1 != v.rail.drag.pt) return;
                            ...
                            if (v.rail.drag) {
                                ...
                                return v.synched("mousemove", function() {
                                    v.rail.drag && 1 == v.rail.drag.pt && (v.showCursor(),
                                        v.rail.drag.hr ? v.doScrollLeft(Math.round(v.scroll.x * v.scrollratio.x),
                                            v.opt.cursordragspeed) : v.doScrollTop(Math.round(v.scroll.y * v.scrollratio.y),
                            ...
                            return v.preventclick ? (v.preventclick.tg.onclick = v.preventclick.click,
                                v.preventclick = !1, v.cancelEvent(e)) : void 0
                        ...
                        this.istouchcapable && (v.bind(v.win,
                            "touchstart",
                            v.ontouchstart),
                            v.bind(document,
                                "touchend",
                        ...
                        v.railh && (v.bind(v.cursorh,
                            ...
                            (v.bind(S.hasmousecapture ?
                                ...
                                v.bind(document,
                                    "mousemove",
                                    v.ontouchmove),
                            v.onclick && v.bind(document,
                                "click", v.onclick),
                            v.opt.cursordragontouch && (v.bind(v.cursor,
                                "mousedown",
                                v.onmousedown),
                                v.bind(v.cursor,
                                    "mousemove",
                                    v.onmousemove),
                            v.cursorh && v.bind(v.cursorh,
                                "mousedown",
                                v.onmousedown),
                            v.cursorh && v.bind(v.cursorh,
                                "mousemove",
                                v.onmousemove))) : (v.bind(S.hasmousecapture ? v.win : document,
                            "mouseup",
                            v.onmouseup),
                            v.bind(document,
                                "mousemove",
                        ...
                        v.onclick && v.bind(document,
                            "click",
                            v.onclick),
                        !v.ispage && v.opt.enablescrollonselection && (v.bind(v.win[0],
                            "mousedown",
                            v.onselectionstart),
                            v.bind(document,
                                "mouseup",
                        ...
                        (v.isiframe || v.bind(S.isie && v.ispage ?
                            document : v.win,
                            "mousewheel",
                            v.onmousewheel),
                            v.bind(v.rail,
                        ...
                        v.ispage || S.cantouch || /HTML|BODY/.test(v.win[0].nodeName) || (v.win.attr("tabindex") || v.win.attr({
                        ...
                        }, v.opt.enablekeyboard && v.bind(document,
                            ...
                            v.bind(window, "resize",
                                v.lazyResize),
                            v.bind(window, "orientationchange",
                                v.lazyResize),
                            v.bind(window, "load",
                                v.lazyResize),
                    ...
                    v.onAttributeChange = function() {
                        ...
                        attributes: !1,
                        subtree: !1
                    })) : (v.bind(v.win, S.isie && !S.isie9 ? "propertychange" : "DOMAttrModified",
                        v.onAttributeChange),
                    S.isie9 && v.win[0].attachEvent("onpropertychange",
                        v.onAttributeChange),
                        v.bind(v.win, "DOMNodeRemoved",
                            function(e) {
                        e.target == v.win[0] && v.remove()
                    }))),
                    !v.ispage && v.opt.boxzoom && v.bind(window, "resize",
                        v.resizeZoom),
                    v.istextarea && v.bind(v.win, "mouseup",
                        v.lazyResize),
                        v.checkrtlmode = !0,
                        v.lazyResize(30)
                }
                ...
                "undefined" != typeof o && (v.scroll.x = Math.round(1 * o / v.scrollratio.x))), v.cursor.css({
                ...
                if (0 == v.page.maxh ? (v.hideRail(), v.scrollvaluemax = 0,
                        v.scroll.y = 0,
                        v.scrollratio.y = 0,
                        v.cursorheight = 0,
                        v.setScrollTop(0),
                        v.rail.scrollable = !1) : v.rail.scrollable = !0, 0 == v.page.maxw ?
                        (v.hideRailHr(),
                            v.scrollvaluemaxw = 0,
                            v.scroll.x = 0,
                            v.scrollratio.x = 0,
                        ...
                        v.locked) return v.ispage || v.updateScrollBar(v.view),
                    !1;
                ...
                v.istextarea && v.win.css("resize") && "none" != v.win.css("resize") && (v.view.h -= 20),
                    ...
                    v.cursorwidth = v.opt.cursorfixedheight ? v.opt.cursorfixedheight : Math.max(v.opt.cursorminheight,
                        v.cursorwidth),
                ...
                v.ispage || v.updateScrollBar(v.view), v.scrollratio = {
                ...
                e.preventManipulation && e.preventManipulation(),
                    e.cancelBubble = !0,
                    e.cancel = !0, e.returnValue = !1, !1) : !1
            }, this.stopPropagation = function(e) {
                var e = e.original ? e.original : e ? e : window.event || !1;
                return e ? e.stopPropagation ? e.stopPropagation() : (e.cancelBubble && (e.cancelBubble = !0), !1) : !1
            }, this.showRail = function() {
                return 0 == v.page.maxh || !v.ispage && "none" == v.win.css("display") || (v.visibility = !0, v.rail.visibility = !0,
                    v.rail.css("display", "block")), v
                ...
                v.stop(), v.cursortimeout && clearTimeout(v.cursortimeout),
                    v.doZoomOut(),
                    v.unbindAll(),
                S.isie9 && v.win[0].detachEvent("onpropertychange",
                    v.onAttributeChange),
                v.observer !== !1 && v.observer.disconnect(),
                v.observerremover !== !1 && v.observerremover.disconnect(),
                    v.events = null, v.cursor && v.cursor.remove(),
                ...
                var o = +new Date,
                    t = !1;
                if (v.opt.preservenativescrolling && v.checkarea + 600 < o && (v.nativescrollingarea = v.isScrollable(e), t = !0),
                        v.checkarea = o, v.nativescrollingarea) return !0;
                var r = f(e, !1, t);
                ...
                var o = +new Date,
                    t = !1;
                return v.opt.preservenativescrolling && v.checkarea + 600 < o && (v.nativescrollingarea = v.isScrollable(e), t = !0),
                    v.checkarea = o, v.nativescrollingarea ? !0 : v.locked ? v.cancelEvent(e) : f(e, !0, t)
            }, this.stop = function() {
                return v.cancelScroll(), v.scrollmon && v.scrollmon.stop(),
                    v.cursorfreezed = !1,
                ...
                return v.lasttransitionstyle && v.lasttransitionstyle == r || (v.lasttransitionstyle = r,
                    v.doc.css(S.transitionstyle, r)), t
                ...
                0 == v.opt.bouncescroll && (0 > o ? o = 0 : o > v.page.maxh && (o = v.page.maxh), 0 > e ? e = 0 : e > v.page.maxw && (e = v.page.maxw)),
                    v.scrollrunning && e == v.newscrollx && o == v.newscrolly ? !1 : (v.newscrolly = o,
                        v.newscrollx = e,
                        v.newscrollspeed = t || !1, v.timer ? !1 : void(v.timer = setTimeout(function() {
                    var t = v.getScrollTop(),
                        r = v.getScrollLeft(),
                        i = {};
                    ...
                    if (v.newscrollspeed && v.newscrollspeed <= 1 && (s *= v.newscrollspeed), v.prepareTransition(s, !0),
                        ...
                        S.transitionend ? v.scrollendtrapped || (v.scrollendtrapped = !0,
                            v.bind(v.doc, S.transitionend,
                                v.onScrollEnd, !1)) : (v.scrollendtrapped && clearTimeout(v.scrollendtrapped),
                    ...
                    v.synched("doScroll-set", function() {
                        v.timer = 0, v.scrollendtrapped && (v.scrollrunning = !0),
                            v.setScrollTop(v.newscrolly),
                            v.setScrollLeft(v.newscrollx), v.scrollendtrapped || v.onScrollEnd()
                    })
                }, 50)))
                ...
                var e = v.getScrollTop(),
                    o = v.getScrollLeft();
                return v.scrollrunning = !1, S.transitionend || clearTimeout(S.transitionend),
                    v.scrollendtrapped = !1, v._unbind(v.doc, S.transitionend, v.onScrollEnd),
                    v.prepareTransition(0), v.setScrollTop(e), v.railh && v.setScrollLeft(o),
                ...
                v.scrollendtrapped && v._unbind(v.doc, S.transitionend, v.onScrollEnd),
                    v.scrollendtrapped = !1, v.prepareTransition(0),
                v.timerscroll && v.timerscroll.tm && clearInterval(v.timerscroll.tm),
                    v.timerscroll = !1;
                var e = v.getScrollTop(),
                    o = v.getScrollLeft();
                if (v.setScrollTop(e), v.railh && v.setScrollLeft(o),
                        v.noticeCursor(!1, e, o), v.cursorfreezed = !1, 0 > e ? e = 0 : e > v.page.maxh && (e = v.page.maxh),
                        0 > o ? o = 0 : o > v.page.maxw && (o = v.page.maxw),
                    e != v.newscrolly || o != v.newscrollx) return v.doScrollPos(o, e, v.opt.snapbackspeed);
                ...
                function r() {
                    ...
                    if (v.dst.ax) {
                        ...
                        if (v.timer = 0, v.cursorfreezed = !1, v.bzscroll = !1,
                                v.scrollrunning = !1, 0 > o ? o = 0 : o > v.page.maxh && (o = v.page.maxh),
                                0 > i ? i = 0 : i > v.page.maxw && (i = v.page.maxw), i != v.newscrollx || o != v.newscrolly) v.doScrollPos(i, o);
                ...
                return v.cursorfreezed = !1,
                    py = v.getScrollTop(!0), 0 > t && 0 >= py ? v.noticeCursor() : t > v.page.maxh && py >= v.page.maxh ? (v.checkContentSize(),
                ...
                return v.cursorfreezed = !1,
                    px = v.getScrollLeft(!0), 0 > t && 0 >= px ?
                    v.noticeCursor() : t > v.page.maxw && px >= v.page.maxw ? v.noticeCursor() : void v.doScrollLeft(t)
                ...
                if (!v.zoomactive) {
                    ...
                    var o = ["position", "top", "left", "zIndex",
                ...
                return v.zoomactive ? (v.zoomactive = !1, v.win.css("margin", ""),
                    v.win.css(v.zoomrestore.style), S.isios4 && c(window).scrollTop(v.zoomrestore.scrollTop), v.rail.css({
                    "z-index": v.zindex
                }), v.zoom.css({
                    "z-index": v.zindex
        ...
        x = function(e) {
            var o = this;
            this.nc = e, this.lastx = 0, this.lasty = 0, this.speedx = 0,
                this.speedy = 0, this.lasttime = 0, this.steptime = 0,
                this.snapx = !1, this.snapy = !1, this.demulx = 0,
                this.demuly = 0, this.lastscrollx = -1,
                this.lastscrolly = -1, this.chkx = 0,
                this.chky = 0, this.timer = 0, this.time = function() {
                return +new Date
                ...
                var r = !1;
                0 > t ? (t = 0, r = !0) : t > o.nc.page.maxh && (t = o.nc.page.maxh, r = !0),
                    0 > e ? (e = 0, r = !0) : e > o.nc.page.maxw && (e = o.nc.page.maxw, r = !0),
                ...
                if (c || d) {
                    ...
                    o.demulxy = 0, o.lastscrollx = o.nc.getScrollLeft(),
