...
$(function(){
    var bsTable = {
                ...
                function temp(){
                    switch (page){
                        case "userSide":
                            ...
                            $("#btn-changetableRow").one("click",function(){
                                if(bsTable.userValiDate("changetableRow")){
                                    ...
                                    $.ajax({
                                        ...
                                        success:function(data){
                                            if(data.success=="1"){
                                                $("#table5").bootstrapTable('updateRow',{
                                                    index:index,
                                                    row:{
                                                        id:selectRowId,
                                                        name:name,
                        ...
                        default:
                            $.ajax({
                                ...
                                success:function(cdata){
                                    ...
                                    $('#changetableRow-modal').modal('show');
                                    $("#btn-changetableRow").one("click",function(){
                                        var serverIpVal = $.trim($("#changetableRow-modal .addtableRowInput:eq(0)").val());
        ...
        addRowModal:function(titleText,page,watgetUrl){
            ...
            function temp(){
                $("#btn-addtableRow").one("click",function(){
                    switch (page){
                        case "observationPoint":
                                            ...
                                            case 1:
                                                $.ajax({
                                                    ...
                                                    success:function(addData){
                                                        $("#table5").bootstrapTable("load",addData);
                                                    }
                                                });
                                                break;
                                            case 0:
